...
public class TeleporterWorkableHandler extends AbstractWorkableHandler<TeleporterWorkableHandler> {
    ...
    @Override
    public TeleporterWorkableHandler initialize(int busCount) {
