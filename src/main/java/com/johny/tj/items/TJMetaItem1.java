...
public class TJMetaItem1 extends MaterialMetaItem {
    ...
    public void registerSubItems() {
        ...
        UNIVERSAL_CIRCUITS[6] = LUV_UNIVERSAL_CIRCUIT = addItem(1012, GAValues.VN[6].toLowerCase() + "_universal_circuit").setUnificationData(OrePrefix.circuit, CIRCUIT_TIERS[6]);
        ...
        ENDER_FLUID_COVER = addItem(1021, "ender_fluid_cover");
    }
