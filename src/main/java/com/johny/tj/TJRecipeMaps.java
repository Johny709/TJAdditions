...
public class TJRecipeMaps {
    ...
    public static final ParallelRecipeMap[] PARALLEL_ADVANCED_LARGE_CHEMICAL_REACTOR_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_CHEMICAL_REACTOR_RECIPES, PARALLEL_CHEMICAL_PLANT_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_ARC_FURNACE_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_ARC_FURNACE_RECIPES, PARALLEL_PLASMA_ARC_FURNACE_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_ASSEMBLER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_ASSEMBLER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_BREWERY_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_BREWING_MACHINE_RECIPES, PARALLEL_FERMENTING_RECIPES, PARALLEL_CHEMICAL_DEHYDRATOR_RECIPES, PARALLEL_CRACKING_UNIT_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_CANNING_MACHINE_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_CANNER_RECIPES, PARALLEL_FLUID_CANNER_RECIPES, PARALLEL_FLUID_SOLIDIFICATION_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_CENTRIFUGE_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_CENTRIFUGE_RECIPES, PARALLEL_THERMAL_CENTRIFUGE_RECIPES, PARALLEL_GAS_CENTRIFUGE_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_CHEMICAL_REACTOR_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_CHEMICAL_REACTOR_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_CUTTING_MACHINE_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_CUTTER_RECIPES, PARALLEL_LATHE_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_ELECTROLYZER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_ELECTROLYZER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_ELECTROMAGNET_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_POLARIZER_RECIPES, PARALLEL_ELECTROMAGNETIC_SEPARATOR_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_EXTRACTOR_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_FLUID_EXTRACTION_RECIPES, PARALLEL_EXTRACTOR_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_EXTRUDER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_EXTRUDER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_FORGE_HAMMER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_FORGE_HAMMER_RECIPES, PARALLEL_COMPRESSOR_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_LASER_ENGRAVER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_LARGE_ENGRAVER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_MACERATOR_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_MACERATOR_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_MIXER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_LARGE_MIXER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_PACKER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_PACKER_RECIPES, PARALLEL_UNPACKER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_SIFTER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_SIFTER_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_WASHING_MACHINE_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_ORE_WASHER_RECIPES, PARALLEL_CHEMICAL_BATH_RECIPES, PARALLEL_SIMPLE_ORE_WASHER_RECIPES, PARALLEL_AUTOCLAVE_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_LARGE_WIREMILL_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_WIREMILL_RECIPES};
    public static final ParallelRecipeMap[] PARALLEL_PLASMA_CONDENSER_RECIPEMAP = new ParallelRecipeMap[]{PARALLEL_PLASMA_CONDENSER_RECIPES};
