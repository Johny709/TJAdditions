...
import static com.johny.tj.TJRecipeMaps.PARALLEL_EXTRACTOR_RECIPES;
import static com.johny.tj.TJRecipeMaps.PARALLEL_FLUID_EXTRACTION_RECIPES;
...
public class MetaTileEntityParallelLargeExtractor extends ParallelRecipeMapMultiblockController {
    ...
    private static final MultiblockAbility<?>[] ALLOWED_ABILITIES = {IMPORT_ITEMS, EXPORT_ITEMS, EXPORT_FLUIDS, MAINTENANCE_HATCH, INPUT_ENERGY};
    ...
    protected BlockPattern createStructurePattern() {
        ...
        for (int layer = 1; layer < this.parallelLayer; layer++) {
            factoryPattern.aisle("CCCCC", "CCCCC", "CCCCC", "CCCCC", "CCCCC");
